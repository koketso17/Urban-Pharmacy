        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li><a href="admin_self.php">SELF MEDICATION</a></li>
				<li class="active"><a href="admin_files.php">UPLOADED FILES</a></li>
				</li>
			  </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container marginbot-50">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          ...
          <h2 class="h-bold">UPLOADED FILES</h2>
          </div>
          </div>
...
<div class="card shadow mb-8">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">	
                    ...
                    <?php
                    $result = mysqli_query($conn,"SELECT * FROM uploadedfiles");
                    ?>
...
<a href="admin_index.php" class="scrollup"><i class="fa fa-angle-up active"></i></a>
