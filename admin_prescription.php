        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="admin_prescription.php">PRESCRIPTION</a></li>
    ...
    <div class="container marginbot-50">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          ...
          <h2 class="h-bold">PRESCRIPTION</h2>
          </div>
          </div>
...
<a href="admin_prescription.php" class="scrollup"><i class="fa fa-angle-up active"></i></a>
